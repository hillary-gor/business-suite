...
export const metadata = { title: 'Account and settings · SkyJet' };
  ...
  return (
    <>
      <PageHeader
        ...
        description="Company identity, address and the fields that appear on invoices and receipts. Functional currency cannot be changed here."
      />
      <Card>
        <CompanySettingsForm
          profile={{
